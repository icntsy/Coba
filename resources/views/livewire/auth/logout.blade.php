                ...
                <div class="widget-content-left">
                    <div class="btn-group">
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                            {{-- <button type="button" tabindex="0" class="dropdown-item"><a href="{{ route('user.index') }}"></a><i class="pe-7s-users"> </i>User Account</button> --}}
                            {{-- <a href="{{ route('profile.index') }}" class="btn text-warning">
